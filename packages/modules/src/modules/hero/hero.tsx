...
const Hero: ComponentType<HeroProps> = ({ data }) => (
  <section
    className="mx-auto w-[var(--layout-max-content)]  overflow-hidden"
    aria-label={data.title || "Hero section"}
  >
    <div className="grid grid-cols-12 px-[var(--spacing-container)]">
      <div className="backdrop-blur-xs text-forground bg-background relative z-10 col-start-1 col-end-13 row-start-2 row-end-3 w-full p-4 md:col-end-10 md:rounded-tr-xl lg:col-start-1 lg:col-end-7 lg:row-start-1 lg:mb-14 lg:mt-14 lg:self-center lg:p-0">
      ...
      {data.image && (
        <div className="bg-border-light relative col-start-1 col-end-13 row-start-1 row-end-2 flex items-end lg:col-start-9 lg:col-end-13 lg:row-start-1 lg:row-end-3 lg:aspect-[4/5]">
          <div className="relative aspect-video w-full md:aspect-[21/9] lg:row-start-2 lg:row-end-3 lg:-ml-14 lg:mb-14 lg:aspect-[4/5] lg:h-auto lg:w-[60%]">
            <Image
